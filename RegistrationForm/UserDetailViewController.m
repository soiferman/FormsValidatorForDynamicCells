...
- (void)fillModel {
    [self.regModel fieldWithKey:@"firstName"].value = self.userModel.firstName;
    NSLog(@"%@", self.userModel.firstName);
}
...
- (IBAction)saveButton:(id)sender {
    ...
    if (![self.regModel validate]) {
        ...
        UserModel *userModel = [NSEntityDescription insertNewObjectForEntityForName:@"Users" inManagedObjectContext:self.managedObjectContext];
        userModel.firstName = [self.regModel fieldWithKey:@"firstName"].value;
        userModel.lastName = [self.regModel fieldWithKey:@"lastName"].value;
        userModel.email = [self.regModel fieldWithKey:@"email"].value;
        userModel.phone = [self.regModel fieldWithKey:@"phone"].value;
        userModel.password = [self.regModel fieldWithKey:@"password"].value;
        userModel.position = [self.regModel fieldWithKey:@"position"].value;
